...
$string['attendancegradeenabled'] = 'Calificar automáticamente la asistencia en Moodle';
...
$string['attendanceReportIntro'] = 'Revise la asistencia de todas las sesiones de Edusign de esta actividad.';
$string['reportSummary'] = 'Resumen del informe';
$string['attendanceRate'] = 'Tasa de asistencia';
$string['moodleGrade'] = 'Nota Moodle';
$string['attendancegradepolicy'] = 'Presencias + ausencias justificadas';
$string['expectedSignatures'] = 'firmas esperadas';
$string['needsAttention'] = 'Requiere atención';
$string['attendanceBelowThreshold'] = 'Estudiantes por debajo del 75 % de asistencia';
$string['noStudentsNeedAttention'] = 'Ningún estudiante está por debajo del umbral de atención.';
$string['studentSummary'] = 'Resumen por estudiante';
$string['sessionSummary'] = 'Resumen por sesión';
$string['lastPresent'] = 'Última presencia';
$string['unknownStudent'] = 'Estudiante desconocido';
$string['never'] = 'Nunca';
$string['noReportData'] = 'Todavía no hay datos de asistencia disponibles.';
$string['reportPartialData'] = 'No se pudieron cargar algunas sesiones desde Edusign.';
$string['sessions'] = 'sesiones';
$string['late'] = 'con retraso';
...
$string['qr_code_course_not_linked'] = 'No hay ningún curso Edusign vinculado a esta sesión';
$string['qr_code_professor_not_linked'] = 'No hay ningún profesor Edusign vinculado a esta sesión';
