...
$string['multiplesessions'] = 'Sesiones múltiples';
$string['repeatsessions'] = 'Repetir la sesión anterior de la siguiente manera';
...
$string['errorrepeatdaysrequired'] = 'Seleccione al menos un día para repetir';
$string['errorrepeatuntilbeforestart'] = 'La fecha final de repetición debe ser igual o posterior a la primera sesión';
$string['errornosessiongenerated'] = 'No se generó ninguna sesión con la configuración de repetición';
...
$string['justifiedAbsence'] = 'Ausencia justificada';
...
$string['defaultSessionTitle'] = 'Mi hoja de asistencia';
$string['session_updated_success'] = 'Sesión actualizada con éxito';
$string['session_updated_error'] = 'Se ha producido un error al actualizar la sesión: {$a}';
$string['session_created_success'] = 'Sesión creada con éxito';
$string['sessions_created_success'] = '{$a} sesión(es) creada(s) con éxito';
$string['session_created_error'] = 'Se ha producido un error al crear la sesión: {$a}';
$string['creatingSessionsOnEdusign'] = 'Creando sesiones en Edusign...';
$string['savingSessionOnEdusign'] = 'Guardando sesión en Edusign...';
$string['course_linked_success'] = 'Curso vinculado con éxito a la API de Edusign';
$string['course_linked_error'] = 'Se ha producido un error al vincular el curso con la API de Edusign: {$a}';
$string['course_updated_success'] = 'Curso actualizado con éxito en la API de Edusign';
$string['course_updated_error'] = 'Se ha producido un error al actualizar el curso en la API de Edusign: {$a}';
$string['invalid_session_id'] = 'Identificador de sesión no válido';
$string['session_not_found'] = 'Sesión no encontrada';
$string['session_removed_error'] = 'Se ha producido un error al eliminar la sesión: {$a}';
$string['session_archived_error'] = 'Se ha producido un error al archivar la sesión: {$a}';
...
$string['displayQRCode'] = 'Mostrar código QR';
$string['qrCodeModalTitle'] = 'Código QR';
$string['qr_code_link_unavailable'] = 'No hay ningún código QR disponible para esta sesión';
$string['qr_code_link_error'] = 'No se puede abrir la ventana del código QR: {$a}';
...
$string['studentDelayModalTitle'] = 'Retraso del estudiante';
$string['delayMinutesAriaLabel'] = 'Minutos de retraso';
