...
$string['attendancegradeenabled'] = 'Noter automatiquement l\'assiduité dans Moodle';
...
$string['attendanceReportIntro'] = 'Consultez les présences de toutes les sessions Edusign de cette activité.';
$string['reportSummary'] = 'Synthèse du rapport';
$string['attendanceRate'] = 'Taux de présence';
$string['moodleGrade'] = 'Note Moodle';
$string['attendancegradepolicy'] = 'Présences + absences justifiées';
$string['expectedSignatures'] = 'signatures attendues';
$string['needsAttention'] = 'À surveiller';
$string['attendanceBelowThreshold'] = 'Étudiants sous 75 % de présence';
$string['noStudentsNeedAttention'] = 'Aucun étudiant n\'est sous le seuil de surveillance.';
$string['studentSummary'] = 'Synthèse par étudiant';
$string['sessionSummary'] = 'Synthèse par session';
$string['lastPresent'] = 'Dernière présence';
$string['unknownStudent'] = 'Étudiant inconnu';
$string['never'] = 'Jamais';
$string['noReportData'] = 'Aucune donnée de présence n\'est disponible pour le moment.';
$string['reportPartialData'] = 'Certaines sessions n\'ont pas pu être chargées depuis Edusign.';
...
$string['qr_code_course_not_linked'] = 'Aucun cours Edusign n\'est lié à cette session';
$string['qr_code_professor_not_linked'] = 'Aucun professeur Edusign n\'est lié à cette session';
