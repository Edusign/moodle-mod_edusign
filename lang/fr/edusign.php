...
$string['justifiedAbsence'] = 'Absence justifiée';
...
$string['creatingSessionsOnEdusign'] = 'Création des sessions sur Edusign...';
$string['savingSessionOnEdusign'] = 'Enregistrement de la session sur Edusign...';
...
$string['displayQRCode'] = 'Afficher le QR code';
$string['qrCodeModalTitle'] = 'QR code';
$string['qr_code_link_unavailable'] = 'Aucun QR code n\'est disponible pour cette session';
$string['qr_code_link_error'] = 'Impossible d\'ouvrir la fenêtre du QR code : {$a}';
...
$string['sessiontype_help'] = 'Vous pouvez ajouter des sessions pour tous les étudiants ou pour un groupe d\'étudiants. Les types disponibles dépendent du mode de groupe de l\'activité.<br><br><ul><li>En mode de groupe « Aucun groupe », vous pouvez uniquement ajouter des sessions pour tous les étudiants.</li><li>En mode de groupe « Groupes séparés », vous pouvez uniquement ajouter des sessions pour un groupe d\'étudiants.</li><li>En mode de groupe « Groupes visibles », vous pouvez ajouter les deux types de sessions.</li></ul>';
$string['commonsession'] = 'Tous les étudiants';
$string['groupsession'] = 'Groupe d\'étudiants';
$string['nogroups'] = 'Aucun groupe disponible';
$string['errorgroupsnotselected'] = 'Sélectionnez au moins un groupe';
